...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Panel ID="Panel1" runat="server" Height="637px">
        ...
        <br />
        <asp:GridView ID="GridViewStaff" runat="server" Height="295px" Width="100%" AutoGenerateSelectButton="True" BorderColor="Black" BorderStyle="Inset" HorizontalAlign="Center" OnSelectedIndexChanged="GridViewStaff_SelectedIndexChanged" >

...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Panel ID="Panel1" runat="server" Height="637px">
        ...
        <br />
        <asp:GridView ID="GridViewCustom" runat="server" Height="295px" Width="100%" AutoGenerateSelectButton="True" HorizontalAlign="Center" OnSelectedIndexChanged="GridViewCustom_SelectedIndexChanged" CellPadding="4" ForeColor="#333333" GridLines="None" >
